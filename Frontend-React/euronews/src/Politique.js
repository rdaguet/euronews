...
const Politique = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:3001/api/articles')
            .then(response => {
                ...
                const filteredArticles = response.data.filter(article => article.tags && article.tags.includes("politique"));
    ...
    return (
        <div>
            ...
            <div className="bannerpolitique">
                <h1>POLITIQUE</h1>
            </div>

            <h1 id='Articles'>Politique</h1>
            <div>
